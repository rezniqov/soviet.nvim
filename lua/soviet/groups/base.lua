...
function M.get(c, opts)
  ...
  return {
    ...
    Constant                    = { fg = c.ochre }, -- (preferred) any constant
    ...
    DiagnosticVirtualTextOk     = { bg = Util.blend_bg(c.git.add, 0.1), fg = c.git.add },
    DiagnosticUnderlineError    = { undercurl = true, sp = c.error }, -- Used to underline "Error" diagnostics
    DiagnosticUnderlineWarn     = { undercurl = true, sp = c.warning }, -- Used to underline "Warning" diagnostics
    DiagnosticUnderlineInfo     = { undercurl = true, sp = c.info }, -- Used to underline "Information" diagnostics
    DiagnosticUnderlineHint     = { undercurl = true, sp = c.hint }, -- Used to underline "Hint" diagnostics
    DiagnosticUnderlineOk       = { undercurl = true, sp = c.git.add },
    DiagnosticDeprecated        = { strikethrough = true, sp = c.muted },
