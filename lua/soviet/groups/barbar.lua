...
function M.get(c)
  ...
  return {
    ...
    BufferAlternateTarget  = { bg = c.fg_gutter, fg = c.accent },
    ...
    BufferCurrentTarget    = { bg = c.bg, fg = c.accent },
    ...
    BufferInactiveTarget   = { bg = Util.blend_bg(c.bg_highlight, 0.4), fg = c.accent },
    ...
    BufferVisibleTarget    = { bg = c.bg_statusline, fg = c.accent },
